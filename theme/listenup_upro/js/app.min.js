(() => {
  ...
  let s = (e, t = 500, s = 0) => {
    ...
    r = (e = 500) => {
      ...
      if (n) {
        ...
        t.style.paddingRight = window.innerWidth - document.querySelector(".wrapper").offsetWidth + "px", document.documentElement.classList.add("lock"), n = !1, setTimeout((function () {
          n = !0
        }), e)
      }
    };
  ...
  e.popup = new class {
    ...
    open(e) {
      if (n)
        if (this.bodyLock = !(!document.documentElement.classList.contains("lock") || this.isOpen), e && "string" == typeof e && "" !== e.trim() && (this.targetOpen.selector = e, this._selectorOpen = !0), this.isOpen && (this._reopen = !0, this.close()), this._selectorOpen || (this.targetOpen.selector = this.lastClosed.selector), this._reopen || (this.previousActiveElement = document.activeElement), this.targetOpen.element = document.querySelector(this.targetOpen.selector), this.targetOpen.element) {
          ...
          })), this.targetOpen.element.classList.add(this.options.classes.popupActive), document.documentElement.classList.add(this.options.classes.bodyActive), this._reopen ? this._reopen = !1 : !this.bodyLock && r(), this.targetOpen.element.setAttribute("aria-hidden", "false"), this.previousOpen.selector = this.targetOpen.selector, this.previousOpen.element = this.targetOpen.element, this._selectorOpen = !1, this.isOpen = !0, setTimeout((() => {
            this._focusTrap()
    ...
    close(e) {
      e && "string" == typeof e && "" !== e.trim() && (this.previousOpen.selector = e), this.isOpen && n && (this.options.on.beforeClose(this), document.dispatchEvent(new CustomEvent("beforePopupClose", {
        detail: {
          popup: this
        }
        ...
        this._focusTrap()
      }), 50), this.popupLogging("Закрив попап"))
    }
    _getHash() {
    ...
    for (let n = 1; n < e.length; n += 1) {
      ...
      if (null != a && (i = a, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
        ...
        for (let s = 0, i = e.length; s < i; s += 1) {
          ...
          void 0 !== n && n.enumerable && (v(t[i]) && v(a[i]) ? a[i].__swiper__ ? t[i] = a[i] : b(t[i], a[i]) : !v(t[i]) && v(a[i]) ? (t[i] = {}, a[i].__swiper__ ? t[i] = a[i] : b(t[i], a[i])) : t[i] = a[i])
        }
      }
    }
    var i;
  ...
  function k(e = {}) {
    return M || (M = function ({
      ...
      const c = n.match(/(iPod)(.*OS\s([\d_]+))?/),
        ...
        u = "Win32" === i;
      let m = "MacIntel" === i;
      return !d && m && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${r}x${o}`) >= 0 && (d = n.match(/(Version)\/([\d.]+)/), d || (d = [0, 1, "13_0_0"]), m = !1), l && !u && (a.os = "android", a.android = !0), (d || p || c) && (a.os = "ios", a.ios = !0), a
    }(e)), M
  }
    ...
    B = e => {
      ...
      if (e.params.rewind || e.params.loop)
        for (let i = n - t; i <= a + t; i += 1) {
          ...
          for (let i = Math.max(n - t, 0); i <= Math.min(a + t, s - 1); i += 1) i !== n && (i > a || i < n) && $(e, i)
    };
  const G = {
    updateSize: function () {
      const e = this;
      let t, s;
      const i = e.el;
      t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth, s = void 0 !== e.params.height && null !== e.params.height ? e.params.height : i.clientHeight, 0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt(T(i, "padding-left") || 0, 10) - parseInt(T(i, "padding-right") || 0, 10), s = s - parseInt(T(i, "padding-top") || 0, 10) - parseInt(T(i, "padding-bottom") || 0, 10), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, {
        width: t,
        height: s,
    ...
    updateSlides: function () {
      ...
      })), i.centeredSlides && i.cssMode && (w(n, "--swiper-centered-offset-before", ""), w(n, "--swiper-centered-offset-after", ""));
      ...
      for (let n = 0; n < u; n += 1) {
        let a;
        if (P = 0, p[n] && (a = p[n]), M && e.grid.updateSlide(n, a, u, t), !p[n] || "none" !== T(a, "display")) {
          if ("auto" === i.slidesPerView) {
            O && (p[n].style[t("width")] = "");
            const r = getComputedStyle(a),
              o = a.style.transform,
              l = a.style.webkitTransform;
            if (o && (a.style.transform = "none"), l && (a.style.webkitTransform = "none"), i.roundLengths) P = e.isHorizontal() ? L(a, "width", !0) : L(a, "height", !0);
            else {
              const e = s(r, "width"),
                t = s(r, "padding-left"),
                i = s(r, "padding-right"),
            ...
            o && (a.style.transform = o), l && (a.style.webkitTransform = l), i.roundLengths && (P = Math.floor(P))
          } else P = (r - (i.slidesPerView - 1) * E) / i.slidesPerView, i.roundLengths && (P = Math.floor(P)), p[n] && (p[n].style[t("width")] = `${P}px`);
          p[n] && (p[n].swiperSlideSize = P), f.push(P), i.centeredSlides ? (x = x + P / 2 + C / 2 + E, 0 === C && 0 !== n && (x = x - r / 2 - E), 0 === n && (x = x - r / 2 - E), Math.abs(x) < .001 && (x = 0), i.roundLengths && (x = Math.floor(x)), A % i.slidesPerGroup == 0 && h.push(x), m.push(x)) : (i.roundLengths && (x = Math.floor(x)), (A - Math.min(e.params.slidesPerGroupSkip, A)) % e.params.slidesPerGroup == 0 && h.push(x), m.push(x), x = x + P + E), e.virtualSize += P + E, C = P, A += 1
        }
      }
      if (e.virtualSize = Math.max(e.virtualSize, r) + v, o && l && ("slide" === i.effect || "coverflow" === i.effect) && (n.style.width = `${e.virtualSize + E}px`), i.setWrapperSize && (n.style[t("width")] = `${e.virtualSize + E}px`), M && e.grid.updateWrapperSize(P, h, t), !i.centeredSlides) {
        const t = [];
      ...
      if (Object.assign(e, {
        ...
        w(n, "--swiper-centered-offset-before", -h[0] + "px"), w(n, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
        const t = -e.snapGrid[0],
          s = -e.slidesGrid[0];
        e.snapGrid = e.snapGrid.map((e => e + t)), e.slidesGrid = e.slidesGrid.map((e => e + s))
      }
      if (u !== c && e.emit("slidesLengthChange"), h.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), m.length !== y && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset(), !(d || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) {
    ...
    updateSlidesProgress: function (e = this && this.translate || 0) {
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        const c = (r + (s.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + o),
          p = (r - a[0] + (s.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + o),
          u = -(r - d),
          h = u + t.slidesSizesGrid[e];
        (u >= 0 && u < t.size - 1 || h > 1 && h <= t.size || u <= 0 && h >= t.size) && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), i[e].classList.add(s.slideVisibleClass)), l.progress = n ? -c : c, l.originalProgress = n ? -p : p
      }
    },
    updateProgress: function (e) {
      ...
      Object.assign(t, {
        ...
        isBeginning: a,
        isEnd: r
      }), (s.watchSlidesProgress || s.centeredSlides && s.autoHeight) && t.updateSlidesProgress(e), a && !l && t.emit("reachBeginning toEdge"), r && !d && t.emit("reachEnd toEdge"), (l && !a || d && !r) && t.emit("fromEdge"), t.emit("progress", n)
    },
    updateSlidesClasses: function () {
      const e = this,
        ...
        r = e => S(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
      let o;
      if (t.forEach((e => {
    ...
    updateActiveIndex: function (e) {
      ...
      if (l >= i.length && (l = i.length - 1), d === a) return l !== o && (t.snapIndex = l, t.emit("snapIndexChange")), void(t.params.loop && t.virtual && t.params.virtual.enabled && (t.realIndex = c(d)));
      let p;
      p = t.virtual && n.virtual.enabled && n.loop ? c(d) : t.slides[d] ? parseInt(t.slides[d].getAttribute("data-swiper-slide-index") || d, 10) : d, Object.assign(t, {
        ...
        previousIndex: a,
        activeIndex: d
      }), t.initialized && B(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), r !== p && t.emit("realIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && t.emit("slideChange")
    },
  ...
  const H = {
    slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
      ...
      if (a.animating && o.preventInteractionOnTransition || !m && !i && !n) return !1;
    ...
    slideToLoop: function (e = 0, t = this.params.speed, s = !0, i) {
      ...
      const n = this;
      let a = e;
      return n.params.loop && (n.virtual && n.params.virtual.enabled ? a += n.virtual.slidesBefore : a = n.getSlideIndexByData(a)), n.slideTo(a, t, s, i)
    },
    ...
    slidePrev: function (e = this.params.speed, t = !0, s) {
      ...
      let f = 0;
      if (void 0 !== m && (f = r.indexOf(m), f < 0 && (f = i.activeIndex - 1), "auto" === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && (f = f - i.slidesPerViewDynamic("previous", !0) + 1, f = Math.max(f, 0))), n.rewind && i.isBeginning) {
    ...
    slideToClickedSlide: function () {
      ...
      if (t.loop) {
        ...
        n = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? a < e.loopedSlides - i / 2 || a > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), a = e.getSlideIndex(S(s, `${r}[data-swiper-slide-index="${n}"]`)[0]), m((() => {
          e.slideTo(a)
        }))) : e.slideTo(a) : a > e.slides.length - i ? (e.loopFix(), a = e.getSlideIndex(S(s, `${r}[data-swiper-slide-index="${n}"]`)[0]), m((() => {
          e.slideTo(a)
        }))) : e.slideTo(a)
      } else e.slideTo(a)
    }
  ...
  const F = {
    ...
    loopFix: function ({
      ...
      if (o.allowSlidePrev = !0, o.allowSlideNext = !0, o.virtual && u.virtual.enabled) return t && (u.centeredSlides || 0 !== o.snapIndex ? u.centeredSlides && o.snapIndex < u.slidesPerView ? o.slideTo(o.virtual.slides.length + o.snapIndex, 0, !1, !0) : o.snapIndex === o.snapGrid.length - 1 && o.slideTo(o.virtual.slidesBefore, 0, !1, !0) : o.slideTo(o.virtual.slides.length, 0, !1, !0)), o.allowSlidePrev = d, o.allowSlideNext = c, void o.emit("loopFix");
      const h = "auto" === u.slidesPerView ? o.slidesPerViewDynamic() : Math.ceil(parseFloat(u.slidesPerView, 10));
      let m = u.loopedSlides || h;
      m % u.slidesPerGroup != 0 && (m += u.slidesPerGroup - m % u.slidesPerGroup), o.loopedSlides = m;
      const f = [],
        g = [];
      let v = o.activeIndex;
      void 0 === n ? n = o.getSlideIndex(o.slides.filter((e => e.classList.contains(u.slideActiveClass)))[0]) : v = n;
      const b = "next" === s || !s,
        w = "prev" === s || !s;
      let y = 0,
        S = 0;
      if (n < m) {
        ...
        S = Math.max(n - (o.slides.length - 2 * m), u.slidesPerGroup);
        for (let e = 0; e < S; e += 1) {
          const t = e - Math.floor(e / l.length) * l.length;
          g.push(t)
        }
      ...
      if (w && f.forEach((e => {
        ...
        })), o.recalcSlides(), "auto" === u.slidesPerView && o.updateSlides(), u.watchSlidesProgress && o.updateSlidesOffset(), t)
        if (f.length > 0 && w)
          if (void 0 === e) {
            const e = o.slidesGrid[v],
              t = o.slidesGrid[v + y] - e;
            r ? o.setTranslate(o.translate - t) : (o.slideTo(v + y, 0, !1, !0), i && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t))
          } else i && o.slideToLoop(e, 0, !1, !0);
      else if (g.length > 0 && b)
        if (void 0 === e) {
          const e = o.slidesGrid[v],
            t = o.slidesGrid[v - S] - e;
          r ? o.setTranslate(o.translate - t) : (o.slideTo(v - S, 0, !1, !0), i && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t))
  ...
  function V(e) {
    ...
    if (a.noSwiping && (g ? function (e, t = this) {
      ...
      }(m, d) : d.closest(m))) return void(t.allowClick = !0);
    ...
    Object.assign(n, {
      ...
      isScrolling: void 0,
      startMoving: void 0
    }), r.startX = v, r.startY = b, n.touchStartTime = f(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (n.allowThresholdMove = !1);
    let S = !0;
    d.matches(n.focusableElements) && (S = !1, "SELECT" === d.nodeName && (n.isTouched = !1)), s.activeElement && s.activeElement.matches(n.focusableElements) && s.activeElement !== d && s.activeElement.blur();
    const E = S && t.allowTouchMove && a.touchStartPreventDefault;
    !a.touchStartForcePreventDefault && !E || d.isContentEditable || l.preventDefault(), a.freeMode && a.freeMode.enabled && t.freeMode && t.animating && !a.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", l)
  }
  ...
  function N(e) {
    ...
    if (!s.allowTouchMove) return l.target.matches(i.focusableElements) || (s.allowClick = !1), void(i.isTouched && (Object.assign(a, {
      startX: u,
      startY: h,
    ...
    if (void 0 === i.isScrolling) {
      let e;
      s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? i.isScrolling = !1 : m * m + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI, i.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle)
    }
    if (i.isScrolling && s.emit("touchMoveOpposite", l), void 0 === i.startMoving && (a.currentX === a.startX && a.currentY === a.startY || (i.startMoving = !0)), i.isScrolling || s.zoom && s.params.zoom && s.params.zoom.enabled && i.evCache.length > 1) return void(i.isTouched = !1);
    ...
    n.oneWayMovement && (v = Math.abs(v) * (r ? 1 : -1), b = Math.abs(b) * (r ? 1 : -1)), a.diff = v, v *= n.touchRatio, r && (v = -v, b = -b);
    ...
    if (!i.isMoved) {
      ...
      i.allowMomentumBounce = !1, !n.grabCursor || !0 !== s.allowSlideNext && !0 !== s.allowSlidePrev || s.setGrabCursor(!0), s.emit("sliderFirstMove", l)
    }
    let S;
    i.isMoved && w !== s.touchesDirection && y && Math.abs(v) >= 1 && (s.loopFix({
      direction: s.swipeDirection,
      setTranslate: !0
    }), S = !0), s.emit("sliderMove", l), i.isMoved = !0, i.currentTranslate = v + i.startTranslate;
    let E = !0,
      T = n.resistanceRatio;
  ...
  function j(e) {
    ...
    if (!n.simulateTouch && "mouse" === e.pointerType) return;
    let d = e;
    if (d.originalEvent && (d = d.originalEvent), s.allowTouchCallbacks && t.emit("touchEnd", d), s.allowTouchCallbacks = !1, !s.isTouched) return s.isMoved && n.grabCursor && t.setGrabCursor(!1), s.isMoved = !1, void(s.startMoving = !1);
    ...
    let u;
    if (s.isTouched = !1, s.isMoved = !1, s.startMoving = !1, u = n.followFinger ? r ? t.translate : -t.translate : -s.currentTranslate, n.cssMode) return;
    ...
    for (let e = 0; e < o.length; e += e < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
      ...
      void 0 !== o[e + t] ? u >= o[e] && u < o[e + t] && (h = e, g = o[e + t] - o[e]) : u >= o[e] && (h = e, g = o[o.length - 1] - o[o.length - 2])
    }
    let v = null,
      b = null;
    ...
    if (p > n.longSwipesMs) {
      ...
      "next" === t.swipeDirection && (w >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? v : h + y) : t.slideTo(h)), "prev" === t.swipeDirection && (w > 1 - n.longSwipesRatio ? t.slideTo(h + y) : null !== b && w < 0 && Math.abs(w) > n.longSwipesRatio ? t.slideTo(b) : t.slideTo(h))
    } else {
      if (!n.shortSwipes) return void t.slideTo(t.activeIndex);
      t.navigation && (d.target === t.navigation.nextEl || d.target === t.navigation.prevEl) ? d.target === t.navigation.nextEl ? t.slideTo(h + y) : t.slideTo(h) : ("next" === t.swipeDirection && t.slideTo(null !== v ? v : h + y), "prev" === t.swipeDirection && t.slideTo(null !== b ? b : h))
    }
  }
  ...
  const J = (e, t) => {
    ...
    n[l]("pointerdown", e.onTouchStart, {
      ...
      passive: !0
    }), (i.preventClicks || i.preventClicksPropagation) && n[l]("click", e.onClick, !0), i.cssMode && a[l]("scroll", e.onScroll), i.updateOnWindowResize ? e[d](r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[d]("observerUpdate", R, !0), n[l]("load", e.onLoad, {
      capture: !0
    })
  };
  ...
  const te = {
      ...
      events: {
        attachEvents: function () {
          ...
          e.onTouchStart = V.bind(e), e.onTouchMove = N.bind(e), e.onTouchEnd = j.bind(e), s.cssMode && (e.onScroll = Y.bind(e)), e.onClick = W.bind(e), e.onLoad = X.bind(e), U || (t.addEventListener("touchstart", K), U = !0), J(e, "on")
        },
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          }), c && !h ? e.disable() : !c && h && e.enable(), e.currentBreakpoint = r, e.emit("_beforeBreakpoint", o), u && s && (e.loopDestroy(), e.loopCreate(t), e.updateSlides()), e.emit("breakpoint", o)
        },
  ...
  class ie {
    constructor(...e) {
      let t, s;
      1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? s = e[0] : [t, s] = e, s || (s = {}), s = b({}, s), t && !s.el && (s.el = t);
      const i = p();
      ...
      const n = this;
      n.__swiper__ = !0, n.support = O(), n.device = k({
        userAgent: s.userAgent
      }), n.browser = _(), n.eventsListeners = {}, n.eventsAnyListeners = [], n.modules = [...n.__modules__], s.modules && Array.isArray(s.modules) && n.modules.push(...s.modules);
      const a = {};
      n.modules.forEach((e => {
        e({
          params: s,
      ...
      const r = b({}, Z, a);
      return n.params = b({}, r, se, s), n.originalParams = b({}, n.params), n.passedParams = b({}, s), n.params && n.params.on && Object.keys(n.params.on).forEach((e => {
    ...
    getSlideIndex(e) {
      const {
        slidesEl: t,
        params: s
      } = this, i = x(S(t, `.${s.slideClass}, swiper-slide`)[0]);
      return x(e) - i
    }
    ...
    mount(e) {
      ...
      return !n && t.params.createElements && (n = E("div", t.params.wrapperClass), s.append(n), S(s, `.${t.params.slideClass}`).forEach((e => {
        n.append(e)
      }))), Object.assign(t, {
        el: s,
        wrapperEl: n,
        ...
        rtlTranslate: "horizontal" === t.params.direction && ("rtl" === s.dir.toLowerCase() || "rtl" === T(s, "direction")),
        wrongRTL: "-webkit-box" === T(n, "display")
      }), !0
    }
    init(e) {
      const t = this;
    ...
    destroy(e = !0, t = !0) {
      ...
      return void 0 === s.params || s.destroyed || (s.emit("beforeDestroy"), s.initialized = !1, s.detachEvents(), i.loop && s.loopDestroy(), t && (s.removeClasses(), n.removeAttribute("style"), a.removeAttribute("style"), r && r.length && r.forEach((e => {
  ...
  function ae(e, t, s, i) {
    return e.params.createElements && Object.keys(i).forEach((n => {
      if (!s[n] && !0 === s.auto) {
        let a = S(e.el, `.${i[n]}`)[0];
        a || (a = E("div", i[n]), a.className = i[n], e.el.append(a)), s[n] = a, t[n] = a
      }
    })), s
  }
  ...
  function re({
    ...
    s("init", (() => {
      ...
      a = n(a), r = n(r);
      const o = s.target;
      if (e.params.navigation.hideOnClick && !r.includes(o) && !a.includes(o)) {
        if (e.pagination && e.params.pagination && e.params.pagination.clickable && (e.pagination.el === o || e.pagination.el.contains(o))) return;
        let t;
        a.length ? t = a[0].classList.contains(e.params.navigation.hiddenClass) : r.length && (t = r[0].classList.contains(e.params.navigation.hiddenClass)), i(!0 === t ? "navigationShow" : "navigationHide"), [...a, ...r].filter((e => !!e)).forEach((t => t.classList.toggle(e.params.navigation.hiddenClass)))
      }
    }));
    const u = () => {
  ...
  function le({
    ...
    function c(t) {
      ...
      if (!s) return;
      t.preventDefault();
      const i = x(s) * e.params.slidesPerGroup;
      if (e.params.loop) {
    ...
    function p() {
      ...
      if (e.params.loop ? (c = e.previousRealIndex || 0, n = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex) : void 0 !== e.snapIndex ? (n = e.snapIndex, c = e.previousSnapIndex) : (c = e.previousIndex || 0, n = e.activeIndex || 0), "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
        const i = e.pagination.bullets;
        let o, l, u;
        if (s.dynamicBullets && (a = L(i[0], e.isHorizontal() ? "width" : "height", !0), p.forEach((t => {
            t.style[e.isHorizontal() ? "width" : "height"] = a * (s.dynamicMainBullets + 4) + "px"
          })), s.dynamicMainBullets > 1 && void 0 !== c && (r += n - (c || 0), r > s.dynamicMainBullets - 1 ? r = s.dynamicMainBullets - 1 : r < 0 && (r = 0)), o = Math.max(n - r, 0), l = o + (Math.min(i.length, s.dynamicMainBullets) - 1), u = (l + o) / 2), i.forEach((e => {
            const t = [...["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${s.bulletActiveClass}${e}`))].map((e => "string" == typeof e && e.includes(" ") ? e.split(" ") : e)).flat();
            e.classList.remove(...t)
          })), p.length > 1) i.forEach((t => {
          const i = x(t);
          i === n ? t.classList.add(...s.bulletActiveClass.split(" ")) : e.isElement && t.setAttribute("part", "bullet"), s.dynamicBullets && (i >= o && i <= l && t.classList.add(...`${s.bulletActiveClass}-main`.split(" ")), i === o && d(t, "prev"), i === l && d(t, "next"))
        }));
        else {
          const t = i[n];
      ...
      p.forEach(((t, a) => {
        if ("fraction" === s.type && (t.querySelectorAll(oe(s.currentClass)).forEach((e => {
          ...
          let r = 1,
            o = 1;
          "horizontal" === i ? r = a : o = a, t.querySelectorAll(oe(s.progressbarFillClass)).forEach((t => {
            t.style.transform = `translate3d(0,0,0) scaleX(${r}) scaleY(${o})`, t.style.transitionDuration = `${e.params.speed}ms`
          }))
        }
        "custom" === s.type && s.renderCustom ? (t.innerHTML = s.renderCustom(e, n + 1, h), 0 === a && i("paginationRender", t)) : (0 === a && i("paginationRender", t), i("paginationUpdate", t)), e.params.watchOverflow && e.enabled && t.classList[e.isLocked ? "add" : "remove"](s.lockClass)
      }))
    }
    ...
    function u() {
      ...
      "fraction" === t.type && (a = t.renderFraction ? t.renderFraction.call(e, t.currentClass, t.totalClass) : `<span class="${t.currentClass}"></span> / <span class="${t.totalClass}"></span>`), "progressbar" === t.type && (a = t.renderProgressbar ? t.renderProgressbar.call(e, t.progressbarFillClass) : `<span class="${t.progressbarFillClass}"></span>`), e.pagination.bullets = [], n.forEach((s => {
        "custom" !== t.type && (s.innerHTML = a || ""), "bullets" === t.type && e.pagination.bullets.push(...s.querySelectorAll(oe(t.bulletClass)))
    ...
    s("changeDirection", (() => {
      ...
      if (Array.isArray(a) || (a = [a].filter((e => !!e))), e.params.pagination.el && e.params.pagination.hideOnClick && a && a.length > 0 && !n.classList.contains(e.params.pagination.bulletClass)) {
    ...
    const f = () => {
      ...
      t && (t = o(t), t.forEach((t => t.classList.add(e.params.pagination.paginationDisabledClass)))), m()
    };
    Object.assign(e.pagination, {
      enable: () => {
        ...
        t && (t = o(t), t.forEach((t => t.classList.remove(e.params.pagination.paginationDisabledClass)))), h(), u(), p()
      },
      disable: f,
      render: u,
      update: p,
  ...
  window.addEventListener("load", (function (e) {
    document.querySelector(".swiper") && (new ne(".testimonials__slider", {
      modules: [le],
      observer: !0,
      observeParents: !0,
      centeredSlides: !0,
  ...
  setTimeout((() => {
    ...
    })), t.any() && document.documentElement.classList.add("touch"), document.querySelector(".icon-menu") && document.addEventListener("click", (function (e) {
      n && e.target.closest(".icon-menu") && (((e = 500) => {
    ...
    function () {
      ...
      if (e.length > 0) {
        ...
        function a(e, t = !1) {
          e.forEach((e => {
            e = t ? e.item : e, t.matches || !t ? (e.classList.add("_spoller-init"), r(e)) : (e.classList.remove("_spoller-init"), r(e, !1))
          }))
        }
        ...
        function r(e, t = !0) {
          ...
          s.length && (s = Array.from(s).filter((t => t.closest("[data-spollers]") === e)), s.forEach((e => {
            ...
            t ? (s.removeAttribute("tabindex"), e.hasAttribute("data-open") ? (s.classList.add("_spoller-active"), e.open = !0) : (e.open = !1, s.nextElementSibling.hidden = !0)) : (s.setAttribute("tabindex", "-1"), s.classList.remove("_spoller-active"), e.open = !0, s.nextElementSibling.hidden = !1)
          })))
        }

        function l(e) {
          const t = e.target;
          if (t.closest("summary") && t.closest("[data-spollers]").classList.contains("_spoller-init")) {
            const n = t.closest("summary"),
              a = n.closest("details"),
              r = n.closest("[data-spollers]"),
              o = r.hasAttribute("data-one-spoller"),
              l = r.dataset.spollersSpeed ? parseInt(r.dataset.spollersSpeed) : 500;
            r.querySelectorAll("._slide").length || (o && !a.open && d(r), a.open ? setTimeout((() => {
              a.open = !1
            }), l) : a.open = !0, n.classList.toggle("_spoller-active"), ((e, t = 500) => {
              e.hidden ? i(e, t) : s(e, t)
            })(n.nextElementSibling, l)), e.preventDefault()
          }
          if (!t.closest("[data-spollers]")) {
            ...
            e.length && e.forEach((e => {
              ...
              if (t.classList.contains("_spoller-init")) {
                const n = t.dataset.spollersSpeed ? parseInt(t.dataset.spollersSpeed) : 500;
                e.classList.remove("_spoller-active"), s(e.nextElementSibling, n), setTimeout((() => {
                  i.open = !1
                }), n)
              }
            }))
        ...
        function d(e) {
          ...
          if (t && !e.querySelectorAll("._slide").length) {
            const i = t.querySelector("summary"),
              n = e.dataset.spollersSpeed ? parseInt(e.dataset.spollersSpeed) : 500;
            i.classList.remove("_spoller-active"), s(i.nextElementSibling, n), setTimeout((() => {
              t.open = !1
            }), n)
          }
        }
    ...
    function () {
      ...
      if (e.length > 0) {
        ...
        s && s.startsWith("tab-") && (t = s.replace("tab-", "").split("-")), e.forEach(((e, s) => {
          e.classList.add("_tab-init"), e.setAttribute("data-tabs-index", s), e.addEventListener("click", r),
            function (e) {
              ...
              i.length && (i = Array.from(i).filter((t => t.closest("[data-tabs]") === e)), s = Array.from(s).filter((t => t.closest("[data-tabs]") === e)), i.forEach(((e, i) => {
      ...
      function n(e, t) {
        e.forEach((e => {
          ...
          i = Array.from(i).filter((t => t.closest("[data-tabs]") === e)), a = Array.from(a).filter((t => t.closest("[data-tabs]") === e)), a.forEach(((a, r) => {
            t.matches ? (n.append(i[r]), n.append(a), e.classList.add("_tab-spoller")) : (s.append(i[r]), e.classList.remove("_tab-spoller"))
          }))
        }))
      }
      ...
      function a(e) {
        ...
        if (n.length > 0) {
          ...
          n = Array.from(n).filter((t => t.closest("[data-tabs]") === e)), t = Array.from(t).filter((t => t.closest("[data-tabs]") === e)), n.forEach(((e, n) => {
            var l;
            t[n].classList.contains("_tab-active") ? (r ? i(e, r) : e.hidden = !1, o && !e.closest(".popup") && (l = (l = `tab-${a}-${n}`) ? `#${l}` : window.location.href.split("#")[0], history.pushState("", "", l))) : r ? s(e, r) : e.hidden = !0
          }))
        }
      }
      ...
      function l(e, t) {
        e.forEach((e => {
          ! function (e, t = !1) {
            let n = (e = t ? e.item : e).querySelectorAll("[data-showmore-content]"),
              a = e.querySelectorAll("[data-showmore-button]");
            n = Array.from(n).filter((t => t.closest("[data-showmore]") === e))[0], a = Array.from(a).filter((t => t.closest("[data-showmore]") === e))[0];
            const r = d(e, n);
            (t.matches || !t) && r < c(n) ? (s(n, 0, e.classList.contains("_showmore-active") ? c(n) : r), a.hidden = !1) : (i(n, 0, r), a.hidden = !0)
          }(e, t)
        }))
      }
      ...
      function d(e, t) {
        let s = 0;
        const i = e.dataset.showmore ? e.dataset.showmore : "size",
          n = parseFloat(getComputedStyle(t).rowGap) ? parseFloat(getComputedStyle(t).rowGap) : 0;
        if ("items" === i) {
          const e = t.dataset.showmoreContent ? t.dataset.showmoreContent : 3,
            i = t.children;
          for (let t = 1; t < i.length; t++) {
            const n = i[t - 1],
              a = parseFloat(getComputedStyle(n).marginTop) ? parseFloat(getComputedStyle(n).marginTop) : 0,
              r = parseFloat(getComputedStyle(n).marginBottom) ? parseFloat(getComputedStyle(n).marginBottom) : 0;
            if (s += n.offsetHeight + a, t == e) break;
            s += r
          }
          n && (s += (e - 1) * n)
      ...
      function c(e) {
        ...
        e.style.removeProperty("height"), e.closest("[hidden]") && (t = e.closest("[hidden]"), t.hidden = !1);
        let i = e.offsetHeight;
      ...
      function p(e) {
        ...
        if ("click" === o) {
          if (t.closest("[data-showmore-button]")) {
            const e = t.closest("[data-showmore-button]").closest("[data-showmore]"),
              n = e.querySelector("[data-showmore-content]"),
              a = e.dataset.showmoreButton ? e.dataset.showmoreButton : "500",
              r = d(e, n);
            n.classList.contains("_slide") || (e.classList.contains("_showmore-active") ? s(n, a, r) : i(n, a, r), e.classList.toggle("_showmore-active"))
          }
        } else "resize" === o && (n && n.length && l(n), a && a.length && r(a))
      }
      t.length && (n = Array.from(t).filter((function (e, t, s) {
        return !e.dataset.showmoreMedia
      })), n.length && l(n), document.addEventListener("click", p), window.addEventListener("resize", p), a = o(t, "showmoreMedia"), a && a.length && (a.forEach((e => {
        e.matchMedia.addEventListener("change", (function () {
          l(e.itemsArray, e.matchMedia)
        }))
      })), r(a)))
